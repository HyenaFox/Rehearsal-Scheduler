...
export const STORAGE_KEYS = {
  ...
  USERS: '@rehearsal_scheduler_users',
  CURRENT_USER: '@rehearsal_scheduler_current_user',
  USER_PROFILES: '@rehearsal_scheduler_user_profile',
  MASTER_ACTORS: '@rehearsal_scheduler_master_actors',
};
