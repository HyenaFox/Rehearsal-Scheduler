...
export default function AvailabilityCalendar({ 
  ...
  const [selectionMode, setSelectionMode] = useState('single'); // 'single', 'row', 'column'
  ...
  return (
    <View style={styles.calendarContainer}>
      ...
      <View style={styles.controlsContainer}>
        ...
        >
          <Text style={styles.modeButtonText}>
            Mode: {selectionMode === 'single' ? '1️⃣' : selectionMode === 'row' ? '↔️' : '↕️'}
          </Text>
        </TouchableOpacity>
      ...
      <View style={styles.instructions}>
        ...
        <Text style={styles.instructionText}>
          Mode: {selectionMode === 'single' ? 'Single cell' : selectionMode === 'row' ? 'Entire row' : 'Entire column'}
        </Text>
      </View>
    </View>
  );
